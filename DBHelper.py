...
class DBHelper(object):
    ...
    def add_question_reverse_index_content(self, key_word_id, question_id, weight):
        ...
        :return:
        """
        return self.question_reverse_index.update_one({"word_key_id": key_word_id},
                                                      {"$addToSet": {"content": [question_id, weight]}}, upsert=True)
    ...
    def get_question_by_id(self, qid):
        ...
        :return:
        """
        return self.questions.find_one({"question_id": qid})
